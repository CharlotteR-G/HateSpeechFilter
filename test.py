...
def test_filter_comment_acceptable_message():
    ...
    assert response.status_code == 200
    assert response.json() == {"status": True, "message": "Message was acceptable"}
